...
if __name__ == "__main__":
    print("习思想选择题合集生成工具 v1.2 (带登录功能)")
    print("=" * 50)
    print("功能说明:")
    print("1. 用户登录系统 (默认用户: admin/admin123, lisi/123)")
    print("2. 自动处理文件夹中的所有txt文件")
    print("3. 题目标记与跳转功能")
    print("4. 题目搜索功能")
    print("5. 按题型分类显示")
    print("6. 每题独立确认答案功能")
    ...
    print("8. 标记状态本地保存功能")
    print("9. 题目分类导航功能")
    print("10. 一键显示/隐藏所有答案功能")
    print("11. 一键清除所有标记题目功能")
    print("=" * 50)
    ...
    default_output = os.path.join(input_folder, "习思想选择合集(登录版).html")
